...
export default {
   ...
   * @example
    {
    &emsptext: 'My tag value', &#47* The visible text on display *&#47
    &emspstyle: 'background-color: #ccc', &#47* Adding inline styles is possible *&#47
    &emspclasses: 'custom-class another', &#47* The value will be added as css classes *&#47
    }
   */
  tags: {
    type: Array,
   ...
   * @example
    {
    &enspclasses: 'class', &#47* css class *&#47
    &ensprule: /^([^0-9]*)$/, &#47* RegExp *&#47
    }, {
    &enspclasses: 'no-braces', &#47* css class *&#47
    &ensprule(text) { &#47* function with text as param *&#47
    &ensp&enspreturn text.indexOf('{') !== -1 || text.indexOf('}') !== -1
    &ensp},
    &enspdisableAdd: true, &#47* if the rule matches, the item cannot be added *&#47,
    },
   */
  validation: {
    type: Array,
   ...
   * @example
     ...
     &enspreturn tags.map(t => t.text).indexOf(tag.text) !== -1
    }
   */
  isDuplicate: {
    type: Function,
